...
public class IntArray implements Cloneable {
     ...
     * @return Строковое значение порядка сортировки
     */
    public static String getStringOrder(OrderType order) {
        return switch (order) {
            case OrderType.ascending -> "По возрастанию";
            case OrderType.descending -> "По убыванию";
            case OrderType.unknown -> "Не определено";
            case OrderType.unordered -> "Не отсортирован";
        };
    }
